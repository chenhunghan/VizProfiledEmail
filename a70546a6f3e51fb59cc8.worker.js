...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3_custom = __webpack_require__(54);
	
	var _d3_custom2 = _interopRequireDefault(_d3_custom);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	onmessage = function onmessage(message) {
	    function forceLayoutEngine(message) {
	        var force = _d3_custom2.default.layout.force().nodes(message.data.threads).links(message.data.links).size([message.options.width, message.options.height]).charge(message.options.forceCharge).gravity(message.options.forceGravity).linkDistance(function (d) {
	            return message.options.linkDistance / d.similarity;
	        }).on('tick', function (a) {
	            var percentage = Math.round((1 - (a.alpha - message.options.coolDownStop) / (0.099 - message.options.coolDownStop)) * 100);
...
/***/ }
/******/ ]);
//# sourceMappingURL=a70546a6f3e51fb59cc8.worker.js.map